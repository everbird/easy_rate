...
**This is just a homework project for fun. Please run `easy-rate` in Python 3.5 or above. It requires Python 3.7 or above to run the HTTP Server for testing.**
